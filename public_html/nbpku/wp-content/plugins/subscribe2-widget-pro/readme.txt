...
Donate link: https://wordimpress.com/plugins/subscribe2-widget-pro/
...
[Upgrade to Subscribe2 Widget Premium](http://wordimpress.com/plugins/subscribe2-widget-pro/ "Upgrade to Subscribe2 Widget Premium")
...
== Upgrade Notice ==
Version 2.2.1 implements a more reliable way to detect whether your install already has Subscribe2 HTML or standard active, which Subscribe2 Widget Pro requires.

== Changelog ==

= 2.2.1 =
* More reliable way to detect Subscribe2 HTML and standard.

= 2.2 =
* Added compatibility with Subscribe2 HTML. Thanks to @mattyrob. See here: https://wordpress.org/support/topic/subscribe2-html-2?replies=3
...
* Fixed: Fixed issue with unsubscribe message improperly displaying subscribe message

= 1.2.5.2 =
* Removed plugin-updater in violation of WP.org's plugin repo policy
