...
<meta name="specificfeeds-verification-code" content="vUmVDN8qnFEW6WpcPN2Y"/>
...
<div id="page" class="hfeed site">
  <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'gateway-plus' ); ?></a>
  ...
  <header id="masthead" class="site-header" role="banner">
    ...
    <div class="stick">
      ...
      <nav class="top-bar" data-topbar data-options="mobile_show_parent_link: true;sticky_on: large;">
        ...
        <ul class="title-area">
          <li class="name"></li>
          <li class="toggle-topbar menu-icon"><a href="#"><span><?php _e('Menu','gateway-plus'); ?></span></a></li>
        </ul>
        ...
        <section class="top-bar-section">
          ...
          <?php
            ...
            $defaults = array(
                  ...
                  'walker'         =>  new gateway_plus_foundation_walker()
            );
